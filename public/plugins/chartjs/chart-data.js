$(function() {
	'use strict';
	var ctx1 = document.getElementById('chartBar1') ? 
		document.getElementById('chartBar1').getContext('2d') : null
	...
	var ctx2 = document.getElementById('chartBar2') ?? false
	if (ctx2 !== false) {
		ctx2.getContext('2d');
		new Chart(ctx2, {
			type: 'bar',
	...
	var ctx3 = document.getElementById('chartBar3') ?? false;
	if (ctx3 !== false) {
